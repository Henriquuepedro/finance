    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Gastos',
                    'route'  => 'fixed.expense.index',
                    'icon' => 'fas fa-fw fas fa-hand-point-down',
                ],
                [
                    'text' => 'Ganhos',
                    'route'  => 'fixed.income.index',
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Gastos',
                    'route'  => 'monthly.expense.index',
                    'icon' => 'fas fa-fw fas fa-hand-point-down',
                ],
                [
                    'text' => 'Ganhos',
                    'route'  => 'monthly.income.index',
                    'icon' => 'fas fa-fw fa-hand-holding-usd',
                ]
            ],
        ],
        ...
        'Moment' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => 'https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
