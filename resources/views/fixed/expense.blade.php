...
@section('content_header')
    <h1 class="m-0 text-dark">Gastos Fixo</h1>
@stop
...
@section('js')
    <script>
        ...
        const loadTable = () => {
            ...
            $.get($('#route_expense_list').val(), function(newDataArray) {
                datatable.clear();
...
@section('content')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-end">
                            <button type="button" class="btn btn-primary col-sm-12 pt-3 pb-3" data-toggle="modal" data-target="#addValue"><i class="fa fa-plus"></i> Novo Gasto</button>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12">
    ...
    <div class="modal fade" id="addValue" tabindex="-1" role="dialog" aria-labelledby="exampleAddValue" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="formAddValues" action="{{ route('ajax.fixed.store') }}">
    ...
    <input type="hidden" id="route_expense_list" value="{{ route('ajax.fixed.expense.list') }}">
@stop
